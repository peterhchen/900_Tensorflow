...
# Take bacthes of 10,000 examples.
...
print ("\nsize_histories['Small']:")
print (size_histories['Small'])
...
print ("\nsize_histories['Medium']:")
print (size_histories['Medium'])
...
print ("\nsize_histories['large']:")
print (size_histories['large'])
...
print("\nregularizer_histories['dropout']:")
print(regularizer_histories['dropout'])
...
print("\nregularizer_histories['combined']:")
print(regularizer_histories['combined'])
