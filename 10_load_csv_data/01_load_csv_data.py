...
print ('\ntrain_file_path', train_file_path)  # C:\Users\14088\.keras\datasets\train.csv
print ('test_file_path:', test_file_path)     # C:\Users\14088\.keras\datasets\eval.csv
...
print ("\nSelect Columns for 'survived', 'age', 'n_siblings_spouses', 'parch', 'fare'")
show_batch(temp_dataset)
